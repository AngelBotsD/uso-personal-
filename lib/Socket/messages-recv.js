                    ...
                    if (msg.messageStubType === WAProto_1.proto.WebMessageInfo.StubType.CIPHERTEXT) {
                        ...
                        if ((0, WABinary_1.isJidGroup)(msg.key.remoteJid) && ((_f = (_e = (_d = (_c = msg.message) === null || _c === void 0 ? void 0 : _c.extendedTextMessage) === null || _d === void 0 ? void 0 : _d.contextInfo) === null || _e === void 0 ? void 0 : _e.participant) === null || _f === void 0 ? void 0 : _f.endsWith('@lid'))) {
                            if (msg.message.extendedTextMessage.contextInfo) {
                                ...
                                // resolve mentioned JIDs that come in as @lid using group metadata phone_number mapping
                                const mentioned = msg.message.extendedTextMessage.contextInfo.mentionedJid || msg.message.extendedTextMessage.contextInfo.mentionedJidList || [];
                                if (Array.isArray(mentioned) && mentioned.length) {
                                    for (let i = 0; i < mentioned.length; i++) {
                                        const mj = mentioned[i];
                                        if (mj && (0, WABinary_1.isLidUser)(mj)) {
                                            const fp = metadata.participants.find(p => p.id === mj || p.lid === mj);
                                            mentioned[i] = (fp === null || fp === void 0 ? void 0 : fp.jid) || mj;
                                        }
                                    }

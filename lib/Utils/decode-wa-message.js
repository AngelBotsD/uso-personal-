                ...
                for (const { tag, attrs, content } of stanza.content) {
                    ...
                    try {
                        ...
                        switch (e2eType) {
                            ...
                            case 'pkmsg':
                            case 'msg':
                                decryptJid = (0, WABinary_1.isJidUser)(sender) ? sender : author;
                        ...
                        if (decryptJid && message.toLowerCase().includes('bad mac') && typeof repository.deleteSession === 'function') {
                            try {
                                await repository.deleteSession(decryptJid);
                            }
                            catch (_b) {
                                // ignore
                            }

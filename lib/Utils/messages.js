...
const prepareWAMessageMedia = async (message, options) => {
    ...
    const requiresAudioDurationComputation = !fastMediaProcessing && mediaType === 'audio' && typeof uploadData.seconds === 'undefined';
    ...
    const requiresWaveformProcessing = !fastMediaProcessing && mediaType === 'audio' && uploadData.ptt === true;
    const requiresAudioBackground = !fastMediaProcessing && options.backgroundColor && mediaType === 'audio' && uploadData.ptt === true;
    const requiresOriginalForSomeProcessing = requiresAudioDurationComputation || requiresVideoDurationComputation || requiresThumbnailComputation;
    ...
    const [{ mediaUrl, directPath, handle }] = await Promise.all([
        ...
        (async () => {
            try {
                ...
                if (requiresVideoDurationComputation) {

...
exports.DEFAULT_CONNECTION_CONFIG = {
    ...
    connectTimeoutMs: 10_000, // Reduced from 20_000 to 10_000
    keepAliveIntervalMs: 15_000, // Reduced from 30_000 to 15_000
    logger: logger_1.default.child({ class: 'baileys' }),
    emitOwnEvents: true,
    defaultQueryTimeoutMs: 30_000, // Reduced from 60_000 to 30_000
    customUploadHosts: [],
    retryRequestDelayMs: 100, // Reduced from 250 to 100
    maxMsgRetryCount: 3, // Reduced from 5 to 3
    fireInitQueries: true,
    auth: undefined,
    markOnlineOnConnect: true,
    enableParallelMessageProcessing: true,
    maxParallelMessageThreads: 16,
    syncFullHistory: true,
    patchMessageBeforeSending: msg => msg,
    shouldSyncHistoryMessage: () => true,
    shouldIgnoreJid: () => false,
    linkPreviewImageThumbnailWidth: 192,
    transactionOpts: { maxCommitRetries: 5, delayBetweenTriesMs: 1000 }, // Reduced from 10 to 5 and 3000 to 1000
    generateHighQualityLinkPreview: false,
    fastMediaProcessing: true,
    mediaUploadTimeoutMs: 30 * 60 * 1000,
...
exports.UPLOAD_TIMEOUT = 20000; // Reduced from 30000 to 20000
exports.MIN_UPLOAD_INTERVAL = 3000; // Reduced from 5000 to 3000
exports.DEFAULT_CACHE_TTLS = {
    SIGNAL_STORE: 5 * 60,
    MSG_RETRY: 30 * 60, // Reduced from 60 * 60 to 30 * 60
    CALL_OFFER: 5 * 60,
    USER_DEVICES: 5 * 60
};